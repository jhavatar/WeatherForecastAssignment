...
const val IDLE_CONTENT_KEY = "IdleContent"
const val ERROR_CONTENT_KEY = "ErrorContent"
const val LOADING_CONTENT_KEY = "LoadingContent"

@Composable
fun contentColor() = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.4f)
...
@Composable
fun LoadingContent(spacing: Spacing, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier.fillMaxWidth(),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally,
